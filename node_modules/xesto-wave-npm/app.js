...
const hackerModeGetAuthToken = require("./src/lib/requests/hackerModeGetAuthToken.js");
...
module.exports = {
  fingerIsMoving: function fingerIsMoving(finger) {
  ...
  frameNotValid: function frameNotValid(frame) {
    const firstHand = frame.hands[0];
  ...
  palmMoving: function palmMoving(palmVelocity) {
  ...
  gestureHasEnoughFrames: function gestureHasEnoughFrames(framesInGesture) {
